class PerformersController < ApplicationController
  def index
    ...
    @entities     = ArtsDataService.new.fetch_performers(q: @search_query, page: @page)
  ...
  def show
    ...
    return redirect_to performers_path if @uri.blank?

    service  = ArtsDataService.new
    @entity  = service.fetch_entity_details(uri: @uri)
    return redirect_to performers_path unless @entity
